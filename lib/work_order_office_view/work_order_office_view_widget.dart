...
import 'work_order_office_view_model.dart';
export 'work_order_office_view_model.dart';
...
class WorkOrderOfficeViewWidget extends StatefulWidget {
  const WorkOrderOfficeViewWidget({
    super.key,
  ...
  static String routeName = 'workOrderOfficeView';
  static String routePath = '/workOrderOfficeView';

  @override
  State<WorkOrderOfficeViewWidget> createState() =>
      _WorkOrderOfficeViewWidgetState();
}

class _WorkOrderOfficeViewWidgetState extends State<WorkOrderOfficeViewWidget> {
  late WorkOrderOfficeViewModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WorkOrderOfficeViewModel());
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<DiagnosesRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<DiagnosesRow> workOrderOfficeViewDiagnosesRowList = snapshot.data!;

        return Title(
            title: 'workOrderOfficeView',
                                                                      ...
                                                                      children:
                                                                        ...
                                                                        Row(
                                                                          ...
                                                                          children: [
                                                                            ...
                                                                            if (widget.workOrderRow?.apartmentNumber != null &&
                                                                            ...
                                                                            return Expanded(
                                                                              child: Padding(
                                                                                ...
                                                                                child: InkWell(
                                                                                  ...
                                                                                  onTap: () async {
                                                                                    context.pushNamed(
                                                                                      WorkOrderOfficeViewWidget.routeName,
                                                                                      queryParameters: {
                                                                              ...
                                                                              child: Padding(
                                                                                ...
                                                                                child: FlutterFlowChoiceChips(
                                                                                  options: [
                                                                                    ...
                                                                                    ChipData('Range Cooktop', Icons.microwave_sharp),
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        children:
                                                                          ...
                                                                          Builder(
                                                                            builder:
                                                                                (context) {
                                                                              final appliancesList = workOrderOfficeViewDiagnosesRowList.toList();
                                                                                                ...
                                                                                                children: [
                                                                                                  Padding(
                                                                                                    ...
                                                                                                    child: FFButtonWidget(
                                                                                                      onPressed: () async {
                                                                                                        _model.queryParts = await PartsTable().queryRows(
                                                                                                          queryFn: (q) => q.eqOrNull(
                                                                                                            'diagnosis_id',
                                                                                                            valueOrDefault<String>(
                                                                                                        ...
                                                                                                        await StockPartsTable().insert({
                                                                                                          ...
                                                                                                          'part_name': valueOrDefault<String>(
                                                                                                            _model.queryParts?.firstOrNull?.partName,
                                                                                                            'partname',
                                                                                                          ),
                                                                                                          'part_number': valueOrDefault<String>(
                                                                                                            _model.queryParts?.firstOrNull?.partNumber,
                                                                                                            '1',
                                                                                                          ),
                                                                                                        });
                                                                        ...
                                                                        builder:
                                                                          ...
                                                                          return ListView
                                                                            ...
                                                                            scrollDirection:
                                                                                Axis.vertical,
                                                                            itemCount:
                                                                                listViewSchedulesRowList.length,
                                                                            itemBuilder:
                                                                  ...
                                                                  Builder(
                                                                    builder:
                                                                      ...
                                                                      final appliancesList =
                                                                          workOrderOfficeViewDiagnosesRowList
                                                                              .toList();
