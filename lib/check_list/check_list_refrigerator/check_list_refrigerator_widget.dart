...
import 'check_list_refrigerator_model.dart';
export 'check_list_refrigerator_model.dart';

class CheckListRefrigeratorWidget extends StatefulWidget {
  const CheckListRefrigeratorWidget({
    super.key,
  ...
  @override
  State<CheckListRefrigeratorWidget> createState() =>
      _CheckListRefrigeratorWidgetState();
}

class _CheckListRefrigeratorWidgetState
    extends State<CheckListRefrigeratorWidget> {
  late CheckListRefrigeratorModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CheckListRefrigeratorModel());
                              ...
                              InkWell(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Flexible(
                                      child: Text(
                                        '2. Temperature controls are set correctly',
                                        style: FlutterFlowTheme.of(context)
                                            .bodyLarge
                                            .override(
                                              fontFamily: 'Manrope',
                                        ...
                                        child: Padding(
                                          padding:
                                              EdgeInsetsDirectional.fromSTEB(
                                                  0.0, 0.0, 0.0, 16.0),
                                          child: Text(
                                            '(thermostat at mid-range or desired setting).',
                                            style: FlutterFlowTheme.of(context)
                                                .bodyLarge
                                                .override(
                                                  fontFamily: 'Manrope',
                            ...
                            children: [
                              InkWell(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Text(
                                      '3. Door seals are intact and seal tightly',
                                      style: FlutterFlowTheme.of(context)
                                          .bodyLarge
                                          .override(
                                            fontFamily: 'Manrope',
                                        ...
                                        child: Padding(
                                          padding:
                                              EdgeInsetsDirectional.fromSTEB(
                                                  0.0, 0.0, 0.0, 16.0),
                                          child: Text(
                                            '(no gaps, cracks, or air leaks in gaskets).',
                                            style: FlutterFlowTheme.of(context)
                                                .bodyLarge
                                                .override(
                                                  fontFamily: 'Manrope',
                                        ...
                                        child: Padding(
                                          padding:
                                              EdgeInsetsDirectional.fromSTEB(
                                                  0.0, 0.0, 0.0, 16.0),
                                          child: Text(
                                            '(free of dust and debris for proper heat dissipation).',
                                            style: FlutterFlowTheme.of(context)
                                                .bodyLarge
                                                .override(
                                                  fontFamily: 'Manrope',
                            ...
                            children: [
                              InkWell(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Text(
                                      '5. Evaporator coils are not iced over',
                                      style: FlutterFlowTheme.of(context)
                                          .bodyLarge
                                          .override(
                                            fontFamily: 'Manrope',
                                        ...
                                        child: Padding(
                                          padding:
                                              EdgeInsetsDirectional.fromSTEB(
                                                  0.0, 0.0, 0.0, 16.0),
                                          child: Text(
                                            '(no excessive frost blocking airflow).',
                                            style: FlutterFlowTheme.of(context)
                                                .bodyLarge
                                                .override(
                                                  fontFamily: 'Manrope',
                                        ...
                                        child: Padding(
                                          padding:
                                              EdgeInsetsDirectional.fromSTEB(
                                                  0.0, 0.0, 0.0, 16.0),
                                          child: Text(
                                            '(evaporator and condenser fans run during cooling cycle).',
                                            style: FlutterFlowTheme.of(context)
                                                .bodyLarge
                                                .override(
                                                  fontFamily: 'Manrope',
                                        ...
                                        child: Padding(
                                          padding:
                                              EdgeInsetsDirectional.fromSTEB(
                                                  0.0, 0.0, 0.0, 16.0),
                                          child: Text(
                                            '(compressor motor runs, no frequent clicking or overheating).',
                                            style: FlutterFlowTheme.of(context)
                                                .bodyLarge
                                                .override(
                                                  fontFamily: 'Manrope',
                                        ...
                                        child: Padding(
                                          padding:
                                              EdgeInsetsDirectional.fromSTEB(
                                                  0.0, 0.0, 0.0, 16.0),
                                          child: Text(
                                            '(airflow passages inside fridge/freezer are not blocked).',
                                            style: FlutterFlowTheme.of(context)
                                                .bodyLarge
                                                .override(
                                                  fontFamily: 'Manrope',
                            ...
                            children: [
                              InkWell(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Text(
                                      '9. Defrost system works properly ',
                                      style: FlutterFlowTheme.of(context)
                                          .bodyLarge
                                          .override(
                                            fontFamily: 'Manrope',
                                        ...
                                        child: Padding(
                                          padding:
                                              EdgeInsetsDirectional.fromSTEB(
                                                  0.0, 0.0, 0.0, 16.0),
                                          child: Text(
                                            '(defrost timer/heater operating, no continuous frost buildup).',
                                            style: FlutterFlowTheme.of(context)
                                                .bodyLarge
                                                .override(
                                                  fontFamily: 'Manrope',
                                        ...
                                        child: Padding(
                                          padding:
                                              EdgeInsetsDirectional.fromSTEB(
                                                  0.0, 0.0, 0.0, 16.0),
                                          child: Text(
                                            '(drain pan and tube are clear and draining properly).',
                                            style: FlutterFlowTheme.of(context)
                                                .bodyLarge
                                                .override(
                                                  fontFamily: 'Manrope',
                                        ...
                                        onChanged: (newValue) async {
                                          ...
                                          if (newValue) {
                                            ...
                                            _model.color10 =
                                                FlutterFlowTheme.of(context)
                                                    .tertiary;
                                            _model.checkView2 = 'done';
                                            safeSetState(() {});
                                            await DiagnosesTable().update(
                                              data: {
                                                'its_check_list_done': true,
                                              },
                                              matchingRows: (rows) =>
                                                  rows.eqOrNull(
                                                'diagnosis_id',
