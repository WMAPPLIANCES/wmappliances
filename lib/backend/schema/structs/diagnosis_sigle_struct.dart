...
class DiagnosisSigleStruct extends BaseStruct {
  DiagnosisSigleStruct({
    String? diagnosisId,
    String? workOrderId,
  ...
  static DiagnosisSigleStruct fromMap(Map<String, dynamic> data) =>
      DiagnosisSigleStruct(
  ...
  static DiagnosisSigleStruct? maybeFromMap(dynamic data) => data is Map
      ? DiagnosisSigleStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static DiagnosisSigleStruct fromSerializableMap(Map<String, dynamic> data) =>
      DiagnosisSigleStruct(
  ...
  @override
  String toString() => 'DiagnosisSigleStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    const listEquality = ListEquality();
    return other is DiagnosisSigleStruct &&
...
DiagnosisSigleStruct createDiagnosisSigleStruct({
  String? diagnosisId,
  String? workOrderId,
  String? diagnosisDetails,
  bool? partNeeded,
