...
class NotesDispatchTable extends SupabaseTable<NotesDispatchRow> {
  @override
  String get tableName => 'notes_dispatch';

  @override
  NotesDispatchRow createRow(Map<String, dynamic> data) =>
      NotesDispatchRow(data);
}

class NotesDispatchRow extends SupabaseDataRow {
  NotesDispatchRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => NotesDispatchTable();
