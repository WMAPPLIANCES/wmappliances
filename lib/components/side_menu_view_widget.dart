                    ...
                    children: [
                      ...
                      if ((FFAppState().userRole == 'admin') ||
                        ...
                        MouseRegion(
                          ...
                          onExit: ((event) async {
                            safeSetState(
                                () => _model.itenHoverHovered9 = false);
                          }),
                        ),
                      Divider(
                        thickness: 2.0,
                      ...
                      MouseRegion(
                        ...
                        onEnter: ((event) async {
                          safeSetState(() => _model.itenHoverHovered11 = true);
                        }),
                        onExit: ((event) async {
                          safeSetState(() => _model.itenHoverHovered11 = false);
                        }),
                      ),
                      Divider(
                        thickness: 2.0,
                            ...
                            MouseRegion(
                              ...
                              child: InkWell(
                                ...
                                child: Container(
                                  width: double.infinity,
                                  decoration: BoxDecoration(
                                    color: _model.itenHoverHovered14
                                        ? FlutterFlowTheme.of(context).alternate
                                        : Color(0x00000000),
                                    borderRadius: BorderRadius.circular(8.0),
                                  ),
                              ...
                              onEnter: ((event) async {
                                safeSetState(
                                    () => _model.itenHoverHovered14 = true);
                              }),
                              onExit: ((event) async {
                                safeSetState(
                                    () => _model.itenHoverHovered14 = false);
                              }),
                            ),
                        ],
                      ),
