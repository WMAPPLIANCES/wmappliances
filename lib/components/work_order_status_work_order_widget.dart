...
import 'work_order_status_work_order_model.dart';
export 'work_order_status_work_order_model.dart';

class WorkOrderStatusWorkOrderWidget extends StatefulWidget {
  const WorkOrderStatusWorkOrderWidget({
    super.key,
  ...
  @override
  State<WorkOrderStatusWorkOrderWidget> createState() =>
      _WorkOrderStatusWorkOrderWidgetState();
}

class _WorkOrderStatusWorkOrderWidgetState
    extends State<WorkOrderStatusWorkOrderWidget> {
  late WorkOrderStatusWorkOrderModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WorkOrderStatusWorkOrderModel());
  ...
  Widget build(BuildContext context) {
    ...
    return Align(
      ...
      child: Padding(
        padding: EdgeInsetsDirectional.fromSTEB(16.0, 64.0, 16.0, 64.0),
        child: Container(
