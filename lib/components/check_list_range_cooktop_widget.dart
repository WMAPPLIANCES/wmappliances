...
import 'check_list_range_cooktop_model.dart';
export 'check_list_range_cooktop_model.dart';

class CheckListRangeCooktopWidget extends StatefulWidget {
  const CheckListRangeCooktopWidget({
    super.key,
  ...
  @override
  State<CheckListRangeCooktopWidget> createState() =>
      _CheckListRangeCooktopWidgetState();
}

class _CheckListRangeCooktopWidgetState
    extends State<CheckListRangeCooktopWidget> {
  late CheckListRangeCooktopModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CheckListRangeCooktopModel());
                                        ...
                                        child: Padding(
                                          padding:
                                              EdgeInsetsDirectional.fromSTEB(
                                                  0.0, 0.0, 0.0, 16.0),
                                          child: Text(
                                            '(knobs turn freely or touch controls respond and power on).',
                                            style: FlutterFlowTheme.of(context)
                                                .bodyLarge
                                                .override(
                                                  fontFamily: 'Manrope',
                            ...
                            children: [
                              InkWell(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Text(
                                      '3. Surface heating elements work',
                                      style: FlutterFlowTheme.of(context)
                                          .bodyLarge
                                          .override(
                                            fontFamily: 'Manrope',
                                        ...
                                        child: Padding(
                                          padding:
                                              EdgeInsetsDirectional.fromSTEB(
                                                  0.0, 0.0, 0.0, 16.0),
                                          child: Text(
                                            '(electric coils glow or induction element heats pan).\t',
                                            style: FlutterFlowTheme.of(context)
                                                .bodyLarge
                                                .override(
                                                  fontFamily: 'Manrope',
                                        ...
                                        child: Padding(
                                          padding:
                                              EdgeInsetsDirectional.fromSTEB(
                                                  0.0, 0.0, 0.0, 16.0),
                                          child: Text(
                                            '(igniters spark and light the burners with a steady flame).',
                                            style: FlutterFlowTheme.of(context)
                                                .bodyLarge
                                                .override(
                                                  fontFamily: 'Manrope',
                                        ...
                                        child: Padding(
                                          padding:
                                              EdgeInsetsDirectional.fromSTEB(
                                                  0.0, 0.0, 0.0, 16.0),
                                          child: Text(
                                            '(electric elements heat uniformly; gas flames are blue and even).\t',
                                            style: FlutterFlowTheme.of(context)
                                                .bodyLarge
                                                .override(
                                                  fontFamily: 'Manrope',
                                        ...
                                        child: Padding(
                                          padding:
                                              EdgeInsetsDirectional.fromSTEB(
                                                  0.0, 0.0, 0.0, 16.0),
                                          child: Text(
                                            '(hot surface or burner-on lights illuminate when in use, if applicable).',
                                            style: FlutterFlowTheme.of(context)
                                                .bodyLarge
                                                .override(
                                                  fontFamily: 'Manrope',
                                        ...
                                        child: Padding(
                                          padding:
                                              EdgeInsetsDirectional.fromSTEB(
                                                  0.0, 0.0, 0.0, 16.0),
                                          child: Text(
                                            '(for gas units: no smell of gas when burners and oven are turned off).\t[',
                                            style: FlutterFlowTheme.of(context)
                                                .bodyLarge
                                                .override(
                                                  fontFamily: 'Manrope',
                                        ...
                                        child: Padding(
                                          padding:
                                              EdgeInsetsDirectional.fromSTEB(
                                                  0.0, 0.0, 0.0, 16.0),
                                          child: Text(
                                            '(if part of range: oven heats to set temperature and thermostats work or If the Bake Igniter or Broil does not work, check continuity at the safety valve).',
                                            style: FlutterFlowTheme.of(context)
                                                .bodyLarge
                                                .override(
                                                  fontFamily: 'Manrope',
                            ...
                            children: [
                              InkWell(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Text(
                                      '9. Components are clean and intact',
                                      style: FlutterFlowTheme.of(context)
                                          .bodyLarge
                                          .override(
                                            fontFamily: 'Manrope',
                                        ...
                                        child: Padding(
                                          padding:
                                              EdgeInsetsDirectional.fromSTEB(
                                                  0.0, 0.0, 0.0, 16.0),
                                          child: Text(
                                            '(burner caps, coil connections, wiring in good condition).',
                                            style: FlutterFlowTheme.of(context)
                                                .bodyLarge
                                                .override(
                                                  fontFamily: 'Manrope',
                            ...
                            children: [
                              InkWell(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Text(
                                      '10. No unusual noises or sparks',
                                      style: FlutterFlowTheme.of(context)
                                          .bodyLarge
                                          .override(
                                            fontFamily: 'Manrope',
                                        ...
                                        child: Padding(
                                          padding:
                                              EdgeInsetsDirectional.fromSTEB(
                                                  0.0, 0.0, 0.0, 16.0),
                                          child: Text(
                                            '(no continuous igniter clicking or electrical buzzing during operation).',
                                            style: FlutterFlowTheme.of(context)
                                                .bodyLarge
                                                .override(
                                                  fontFamily: 'Manrope',
