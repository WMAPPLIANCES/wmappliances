...
import 'voice_tradutor_model.dart';
export 'voice_tradutor_model.dart';

class VoiceTradutorWidget extends StatefulWidget {
  const VoiceTradutorWidget({super.key});

  @override
  State<VoiceTradutorWidget> createState() => _VoiceTradutorWidgetState();
}

class _VoiceTradutorWidgetState extends State<VoiceTradutorWidget> {
  late VoiceTradutorModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => VoiceTradutorModel());
                          ...
                          onPressed: (_model.dropDownValue == null ||
                              ...
                              : () async {
                                  await actions.n8nApiCallDiagnosis(
                                    ...
                                    '',
                                    '',
                                    '${_model.textController.text} - Tempo Necessario Para Reparo: ${_model.dropDownValue} Minutos - E Necessario Helper: ${_model.choiceChipsValue}',
                                    '',
                                  );
                                  await showDialog(
                                    context: context,
